...
FUNCTION = "STOCH"
SAVE_PATH = "E:/stock_data/technical_indicators/STOCH"
...
def fetch_data(symbol):
    """Fetches STOCH data for a given symbol"""
    parameters = {
        "function": FUNCTION,
        "symbol": symbol,
        "apikey": API_KEY,
...
def save_data(symbol, data):
    ...
    with open(f"{SAVE_PATH}/{symbol}/{symbol}_STOCH.csv", 'w') as f:
        f.write(data)

if __name__ == "__main__":
    for symbol in symbols:
        print(f"Fetching STOCH data for {symbol}...")
    ...
    print("STOCH data fetching completed.")
