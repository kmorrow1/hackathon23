...
FUNCTION = "VWAP"
SAVE_PATH = "E:/stock_data/technical_indicators/VWAP"
...
def fetch_data(symbol):
    """Fetches VWAP data for a given symbol"""
    parameters = {
        "function": FUNCTION,
        "symbol": symbol,
        "apikey": API_KEY,
...
def save_data(symbol, data):
    ...
    with open(f"{SAVE_PATH}/{symbol}/{symbol}_VWAP.csv", 'w') as f:
        f.write(data)

if __name__ == "__main__":
    for symbol in symbols:
        print(f"Fetching VWAP data for {symbol}...")
    ...
    print("VWAP data fetching completed.")
