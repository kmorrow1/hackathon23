...
FUNCTION = "AROON"
SAVE_PATH = "E:/stock_data/technical_indicators/AROON"
...
def fetch_data(symbol):
    """Fetches AROON data for a given symbol"""
    parameters = {
        "function": FUNCTION,
        "symbol": symbol,
        "apikey": API_KEY,
...
def save_data(symbol, data):
    ...
    with open(f"{SAVE_PATH}/{symbol}/{symbol}_AROON.csv", 'w') as f:
        f.write(data)

if __name__ == "__main__":
    for symbol in symbols:
        print(f"Fetching AROON data for {symbol}...")
    ...
    print("AROON data fetching completed.")
